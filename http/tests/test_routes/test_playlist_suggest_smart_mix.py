...
def test_arg_errors(http_app: FlaskClient):
    ...
    resp = http_app.get("/playlist/suggest/smart-mix")
...
def test_get(http_app: FlaskClient):
    ...
    collection = PlaylistCollection(
        collection_id=uuid4(), username="aaa", collection_name="smart-mixes"
    )
    items = [
    ...
    resp = http_app.get("/playlist/suggest/smart-mix/aaa")
